"""
Django settings for Job_Marketplace_system project.
...
SECRET_KEY = 'django-insecure-x+pgpik3_t8s13_(uakswc+5$hwiqyf5zblfyp1^e@5n#&a#0k'
...
WSGI_APPLICATION = 'Job_Marketplace_system.wsgi.application'
